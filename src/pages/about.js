      ...
      <div className="pagePadding">
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-md">
              <div className="aboutContent">
                ...
                ให้มีการพูดคุย แบ่งปัน ข้อมูล ไม่ว่าจะเป็นทางด้านการเรียน
                หรือไลฟ์สไตล์
          ...
          <div className="row aboutImg">
            ...
            <div
              className="col-md"
              style={{ paddingTop: "2.7%", paddingLeft: "5%" }}
            >
              <div className="quoteBox" style={{ paddingLeft: "5%" }}>
                <span className="aboutQuote">
                  There is no happiness in having or in getting, <br />
                  but in only giving.
                  <br />{" "}
                </span>
              ...
              <ul className="objectiveList">
                <li>
                  เพื่อเสริมสร้างให้นักศึกษามีการแชร์เรื่องราวแก่กันและกัน{" "}
                </li>
                <li>
                  เพื่อให้บุคคลภายนอกได้มีแพลทฟอร์มส่วนกลางในการถามคำถามจากนักศึกษาโดยตรง
                </li>
                <li>
                  เพื่อให้สังคมภายในมหาวิทยาลัยเป็นไปในทางที่ดีขึ้น
                  หลังจากยุคโควิด ที่ทำให้คนเหินห่าง
                </li>
              </ul>
            </div>
          </div>
