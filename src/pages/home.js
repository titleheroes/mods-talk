          ...
          <div className="container" style={{ paddingTop: "2%" }}>
            ...
            <div>
              <div className="row">
                ...
                >
                  สมัครอีเมลล์สกุล @mail.kmutt.ac.th หรือ @kmutt.ac.th ได้จากไหน
                  ?
                </div>
                <div className="col-1">
                  <button
                ...
                {visibility.element1 && (
                  ...
                  >
                    ...
                    <div className="col-sm-10">
                      เนื่องจากเป็นอีเมลล์ที่ใช้ภายในมหาวิทยาลัย
              ...
              <div style={{ paddingBottom: "0.75%" }}>
                {visibility.element4 && (
                  ...
                  >
                    <div className="col-sm-1">คำตอบ : </div>
                    <div className="col">
                      แค่มีอีเมลล์สกุล @mail.kmutt.ac.th หรือ @kmutt.ac.th
              ...
              <div style={{ paddingBottom: "0.75%" }}>
                {visibility.element5 && (
                  ...
                  >
                    <div className="col-sm-1">คำตอบ : </div>
                    <div className="col">
                      สามารถใช้งานได้ ถ้าหากว่าคุณสามารถเข้าถึงอีเมลล์สกุล
